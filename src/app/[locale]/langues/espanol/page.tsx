...
import { Users, Star, Target, GraduationCap } from 'lucide-react';
...
const certs = ['DELE A1', 'DELE A2', 'DELE B1', 'DELE B2', 'DELE C1', 'DELE C2'];
...
export default function EspanolPage() {
  ...
  return (
    <>
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-800 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h1 className="text-4xl md:text-5xl font-heading font-black text-white leading-tight mb-4">
              Español في <span className="text-secondary-500">IMI الناظور</span>
            </h1>
            <p className="text-lg text-gray-200 max-w-2xl leading-relaxed">
              تعلم الإسبانية على يد أساتذة ناطقين أصليين بالطريقة المباشرة. من A1 إلى C2.
              حضّر لشهادات DELE الصادرة عن Instituto Cervantes.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <SectionHeading title="الشهادات" subtitle="شهادات DELE الصادرة عن Instituto Cervantes" />
          <motion.div
            ref={certRef}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <motion.div
              ...
              className="flex-1"
            >
              <div className="w-full h-80 rounded-2xl bg-orange-100 flex items-center justify-center">
                <GraduationCap className="w-32 h-32 text-orange-300" />
              </div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                في IMI، نعتمد الطريقة المباشرة (Direct Method) لتعليم الإسبانية. يتم التحدث
                بالإسبانية فقط منذ الحصة الأولى، مما يسرع عملية التعلم ويكسر حاجز الخوف.
      ...
      <section className="py-16 md:py-20 bg-primary-500">
        <div className="container mx-auto px-4 text-center">
          <SectionHeading title="ابدأ تعلم Español اليوم" subtitle="اختبار تحديد مستوى مجاني - احجز موعدك الآن" light />
