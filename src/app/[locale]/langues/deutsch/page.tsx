...
const certs = ['Goethe-Zertifikat SD2', 'Goethe-Zertifikat ZD', 'Goethe B2', 'Goethe C1', 'Goethe DfdB', 'Chambre de Commerce ZH'];
...
export default function DeutschPage() {
  ...
  return (
    <>
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-yellow-500 via-yellow-600 to-yellow-800 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h1 className="text-4xl md:text-5xl font-heading font-black text-white leading-tight mb-4">
              Deutsch في <span className="text-secondary-500">IMI الناظور</span>
            </h1>
            <p className="text-lg text-gray-200 max-w-2xl leading-relaxed">
              تعلم الألمانية على يد أساتذة ناطقين أصليين بالطريقة المباشرة. من A1 إلى C2.
              حضّر لشهادات Goethe-Zertifikat المعترف بها دولياً.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <motion.div
              ...
              className="flex-1"
            >
              <div className="w-full h-80 rounded-2xl bg-yellow-100 flex items-center justify-center">
                <GraduationCap className="w-32 h-32 text-yellow-300" />
              </div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                في IMI، نعتمد الطريقة المباشرة (Direct Method) لتعليم الألمانية. يتم التحدث
                بالألمانية فقط منذ الحصة الأولى، مما يسرع عملية التعلم ويكسر حاجز الخوف.
      ...
      <section className="py-16 md:py-20 bg-primary-500">
        <div className="container mx-auto px-4 text-center">
          <SectionHeading title="ابدأ تعلم Deutsch اليوم" subtitle="اختبار تحديد مستوى مجاني - احجز موعدك الآن" light />
