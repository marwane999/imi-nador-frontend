...
import { Users, Star, Target, BookOpen, GraduationCap } from 'lucide-react';
...
const formulas = [
  ...
  { icon: BookOpen, title: 'تحضير امتحان الاندماج', desc: 'Inburgeringsexamen — دورة متخصصة لاجتياز امتحان الاندماج المدني', tag: 'اندماج', color: 'bg-accent-100 text-accent-600' },
];
...
const certs = ['Inburgeringsexamen (امتحان الاندماج المدني)', 'شهادة IMI'];
...
export default function DutchPage() {
  ...
  return (
    <>
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-cyan-500 via-cyan-600 to-cyan-800 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h1 className="text-4xl md:text-5xl font-heading font-black text-white leading-tight mb-4">
              Dutch في <span className="text-secondary-500">IMI الناظور</span>
            </h1>
            <p className="text-lg text-gray-200 max-w-2xl leading-relaxed">
              تعلم الهولندية على يد أساتذة ناطقين أصليين بالطريقة المباشرة. من A1 إلى B2.
              حضّر لامتحان Inburgeringsexamen للاندماج المدني.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <SectionHeading title="المستويات" subtitle="من A1 إلى B2" />
          <motion.div
            ref={levelRef}
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <SectionHeading title="الشهادات" subtitle="شهادات رسمية معترف بها" />
          <motion.div
            ref={certRef}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <motion.div
              ...
              className="flex-1"
            >
              <div className="w-full h-80 rounded-2xl bg-cyan-100 flex items-center justify-center">
                <GraduationCap className="w-32 h-32 text-cyan-300" />
              </div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                في IMI، نعتمد الطريقة المباشرة (Direct Method) لتعليم الهولندية. يتم التحدث
                بالهولندية فقط منذ الحصة الأولى، مما يسرع عملية التعلم ويكسر حاجز الخوف.
      ...
      <section className="py-16 md:py-20 bg-primary-500">
        <div className="container mx-auto px-4 text-center">
          <SectionHeading title="ابدأ تعلم Dutch اليوم" subtitle="اختبار تحديد مستوى مجاني - احجز موعدك الآن" light />
